...
class ResNet3DCSNModel(nn.Module):

    def __init__(self, backbone_args, freeze_parameters, pooling_type, dropout_rate):

        super(ResNet3DCSNModel, self).__init__()

        self.backbone = ResNet3dCSN(**backbone_args)
        ...
        self.head = ClassificationHead(input_dimensions=2048)
